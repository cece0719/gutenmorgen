<div class="card">
    <table>
        ...
        <tr>
            ...
            <td>
                <button onclick="$job.showUpdatePopup('${job.jobKey?html}', '${job.name?html}', '${job.processor?html}', '${job.parameter?html}')">
                    수정
                </button>
            </td>
            <td>
                <button onclick="$job.remove('${job.jobKey?html}')">삭제</button>
            </td>
        </tr>
        </#list>
        </tbody>
    ...
    <div class="dimmed">
        <div class="popup">
            <table>
                <tbody>
                <tr>
                    <th colspan="2" class="title">JOB - 신규등록
                        <button type="button" class="cancel" onclick="$job.hideRegisterPopup();">X</button>
                    </th>
                </tr>
                <tr>
                    <th>이름</th>
                        ...
                        <tr>
                            ...
                            <td type="${parameterInfo['type']?html}">
                                <#if parameterInfo['type']! == 'list'>
                                    ...
                                    <button type="button"
                                            onclick="$job.addRegisterParameterList('${key?html}', '${parameterInfo['id']}', $(this).prev().val())">
                                        추가
                                    </button>
                                    <button type="button"
                                            onclick="$job.removeSelectedRegisterParameterList('${key?html}', '${parameterInfo['id']}')">
                                        선택 삭제
                                    </button>
    ...
    <div class="dimmed">
        <div class="popup">
            <table>
                <tbody>
                <tr>
                    <th colspan="2" class="title">JOB - 수정
                        <button type="button" class="cancel" onclick="$job.hideUpdatePopup();">X</button>
                    </th>
                </tr>
                <tr>
                    <th>이름</th>
                        ...
                        <tr>
                            ...
                            <td type="${parameterInfo['type']?html}">
                                <#if parameterInfo['type']! == 'list'>
                                    ...
                                    <button type="button"
                                            onclick="$job.addUpdateParameterList('${key?html}', '${parameterInfo['id']}', $(this).prev().val())">
                                        추가
                                    </button>
                                    <button type="button"
                                            onclick="$job.removeSelectedUpdateParameterList('${key?html}', '${parameterInfo['id']}')">
                                        선택 삭제
                                    </button>
                                <#elseif parameterInfo['type']! == 'text'>
                                    <#if parameterInfo['inputType']! == 'select'>
