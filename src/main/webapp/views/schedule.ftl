<div class="card">
    <table>
        ...
        <tr>
            ...
            <td>
                <button onclick="$schedule.showUpdatePopup('${schedule.scheduleKey?html}','${schedule.name?html}', '${schedule.job.jobKey?html}', '${schedule.timeRegex?html}')">
                    수정
                </button>
            </td>
            <td>
    ...
    <div class="dimmed">
        <div class="popup">
            <table>
                <tbody>
                <tr>
                    <th colspan="2" class="title">SCHEDULE - 신규등록
                        <button type="button" class="cancel" onclick="$schedule.hideRegisterPopup();">X</button>
                    </th>
                </tr>
                <tr>
                    <th>이름</th>
    ...
    <div class="dimmed">
        <div class="popup">
            <table>
                <tbody>
                <tr>
                    <th colspan="2" class="title">SCHEDULE - 수정
                        <button type="button" class="cancel" onclick="$schedule.hideUpdatePopup();">X</button>
                    </th>
                </tr>
                <tr>
                    <th>이름</th>
